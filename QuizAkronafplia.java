...
public class QuizAkronafplia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_akronafplia);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(selectedRadioButton.getId()==R.id.option1c_radiobutton){
                    ...
                    Toast.makeText(QuizAkronafplia.this, "Congratulations! You chose the correct answer.", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(QuizAkronafplia.this, ActivitySigths.class);
                    startActivity(intent);

                }else{
                    Toast.makeText(QuizAkronafplia.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
