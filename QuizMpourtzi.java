...
public class QuizMpourtzi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_mpourtzi);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(selectedRadioButton.getId()==R.id.option1b_radiobutton){
                    ...
                    Toast.makeText(QuizMpourtzi.this, "Congratulations! You chose the correct answer.", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(QuizMpourtzi.this, ActivitySigths.class);
                    startActivity(intent);

                }else{
                    Toast.makeText(QuizMpourtzi.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
