...
public class QuizPalamidi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_palamidi);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(selectedRadioButton.getId()==R.id.option1b_radiobutton){
                    ...
                    Toast.makeText(QuizPalamidi.this, "Congratulations! You chose the correct answer.", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(QuizPalamidi.this, ActivitySigths.class);
                    startActivity(intent);

                }else{
                    Toast.makeText(QuizPalamidi.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
