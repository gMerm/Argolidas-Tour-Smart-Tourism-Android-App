...
public class QuizMikines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_mikines);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(selectedRadioButton.getId()==R.id.option1d_radiobutton){
                    ...
                    Toast.makeText(QuizMikines.this, "Congratulations! You chose the correct answer.", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(QuizMikines.this, ActivitySigths.class);
                    startActivity(intent);

                }else{
                    Toast.makeText(QuizMikines.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
